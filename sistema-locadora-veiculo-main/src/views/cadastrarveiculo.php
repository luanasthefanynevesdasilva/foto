...
<div class="mb-3"><br>
       ...
       <div class="mb-3"><br>     
              ...
              <div class="mb-3">
                        ...
                        <input type="number" max="2021" min="2000" step="any"  name="ano" class="form-control" id="ano" required>
                    </div>
             ...
             <div class="mb-3">
                        ...
                        <input type="text "pattern="[A-Z]{3}[0-9][A-Z][0-9]{2}" title="digite uma placa valida exemplo:ABC1D23 " step="any"  name="placa" class="form-control" id="placa" required>
                    </div>
                    <div class="mb-3">
